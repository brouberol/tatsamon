...
// GetWantReturn return a GET request
func GetWantReturn(path, tatUsername, tatPassword string) ([]byte, error) {
	return reqWant("GET", http.StatusOK, path, nil, tatUsername, tatPassword, 1)
}

// PutWant update a message
...
// PostWant a message to tat engine
...
// DeleteWant a message on tat engine
